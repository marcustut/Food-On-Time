                   ...
                   Swiper(
                    itemBuilder: (BuildContext context, int index) {
                        return new Image.network(
                          "https://www.nestleprofessional.com.my/sites/g/files/gfb566/f/styles/recipe/public/media/beef_rendang_burger.jpg?itok=LnvE_uw2",
                          fit: BoxFit.fill,
                        );
                      },
                      itemCount: 10,
              ...
              child:Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child:Row(
                       children: <Widget>[
                         new Text("Address : Kampus Utama, Jalan Genting Kelang",
